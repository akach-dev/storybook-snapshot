...
const meta: Meta<typeof Task> = {
  ...
  argTypes: {
    changeTaskStatus: {
      ...
      action: 'changeTaskStatus action'
    },
    removeTask: {
      description: 'removeTask description',
      action: 'removeTask action'
    },
    changeTaskTitle: {
      description: 'changeTaskTitle description',
      action: 'changeTaskTitle action'
    },
  },
  args: {
    task: {id: 'sdasdasd', title: 'JS', isDone: true},
    todolistId: 'werwer',
  }
};
